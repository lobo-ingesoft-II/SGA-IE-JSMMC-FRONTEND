...
import {
  ...
  withStyles,
  withTheme
} from "./chunk-4YWQPZR2.js";
import {
  colors_exports
} from "./chunk-MAOECHQN.js";
import {
  Stack_default,
  stackClasses_default
} from "./chunk-AZ2D7ON5.js";
import {
...
var Snackbar = React73.forwardRef(function Snackbar2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded56), other = _objectWithoutPropertiesLoose(props, _excluded214);
  const ownerState = _extends({}, props, {
    anchorOrigin: {
      vertical,
      horizontal
...
var SpeedDial = React75.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    transitionDuration = defaultTransitionDuration,
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded58), other = _objectWithoutPropertiesLoose(props, _excluded215);
...
var SwipeableDrawer = React91.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded69), other = _objectWithoutPropertiesLoose(props, _excluded216);
