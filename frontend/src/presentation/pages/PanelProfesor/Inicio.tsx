            ...
            <Box sx={{ p: 3 }}>
              <Stack spacing={1}>
                <Box display="flex" alignItems="center">
                  ...
                  <Typography variant="subtitle1"><strong>ID:</strong> {profesorData.id}</Typography>
                </Box>
                <Box display="flex" alignItems="center">
                  <EmailIcon sx={{ mr: 1, color: 'text.secondary' }} />
                  <Typography variant="subtitle1"><strong>Email:</strong> {profesorData.correo}</Typography>
                </Box>
                <Box display="flex" alignItems="center">
                  <WorkIcon sx={{ mr: 1, color: 'text.secondary' }} />
                  <Typography variant="subtitle1"><strong>Rol:</strong> {profesorData.rol}</Typography>
                </Box>
              </Stack>
            </Box>
          </Paper>
